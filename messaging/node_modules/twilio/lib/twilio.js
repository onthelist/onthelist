...
Client.prototype.makeCall = function(from, to, opts){
  return new OutgoingCall(from, to, opts, this);
};
...
Client.prototype.simpleSendSms = function(from, to, body, opts, fn){
    var sms = new OutgoingSms(from, to, body, opts, this);
    sms.setup(fn);
};
